...
import { f as defineComponent, i as useRoute, j as toRefs, k as computed, r as resolveComponent, h as unref, o as openBlock, l as createBlock, w as withCtx, m as mergeProps, c as createElementBlock, n as renderSlot, d as createTextVNode, t as toDisplayString, p as createCommentVNode, q as isLinkHttp, s as isLinkMailto, v as isLinkTel, x as useSiteData, y as usePageFrontmatter, z as useSiteLocaleData, A as useDarkMode, B as isArray, b as createBaseVNode, a as createVNode, C as withBase, F as Fragment, D as renderList, E as normalizeClass, G as removeLeadingSlash, H as removeEndingSlash, T as Transition, I as ref, J as watch, K as withDirectives, L as vShow, M as useRouter, u as useRouteLocale, g as useThemeLocaleData, N as isString, O as useNavLink, e as createStaticVNode, P as onMounted, Q as normalizeStyle, R as usePageData, S as useSidebarItems, U as isPlainObject, V as h, W as onUnmounted, X as useScrollPromise } from "./app.e7d24d8d.js";
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("main", {
        ...
        createBaseVNode("header", _hoisted_2$7, [
          createVNode(_component_ClientOnly, null, {
            default: withCtx(() => [
              unref(heroImage) ? (openBlock(), createElementBlock("img", {
                key: 0,
                src: unref(withBase)(unref(heroImage)),
                alt: unref(heroAlt)
          ...
          unref(actions).length ? (openBlock(), createElementBlock("p", _hoisted_6$2, [
...
const _hoisted_6$1 = { class: "nav-dropdown" };
